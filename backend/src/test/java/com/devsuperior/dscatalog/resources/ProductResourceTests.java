...
public class ProductResourceTests {
	...
	@Test
	public void deleteShouldReturnNotFoundWhenIdDoesNotExsist() throws Exception {
		...
		Mockito.verify(service).delete(nonExixtingId);
	}
	
	@Test
	public void deleteShouldReturnClienteErrorWhenDependentId() throws Exception {
